...
import 'package:la_paz_app/localization.dart';
...
void main() async {
  ...
  trufiCfg.map.center = LatLng(-16.489689, -68.119293);
  trufiCfg.map.southWest = LatLng(-16.448122, -68.254410);
  trufiCfg.map.northEast = LatLng(-16.609528, -68.085075);
