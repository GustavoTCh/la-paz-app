...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    "aboutContent" : MessageLookupByLibrary.simpleMessage("Nous sommes une équipe bolivienne et internationale de personnes qui aiment et soutiennent les transports en commun. Nous avons développé cette application pour faciliter l\'utilisation du système de transport en commun à La Paz et dans les environs."),
    ...
    "description" : MessageLookupByLibrary.simpleMessage("La meilleure façon de se déplacer en trufis, micros et bus dans La Paz."),
    ...
    "menuYourPlaces" : MessageLookupByLibrary.simpleMessage("Vos lieux"),
    ...
    "savedSectionAddPlace" : MessageLookupByLibrary.simpleMessage("Autre chose"),
    ...
    "savedSectionSelectIcon" : MessageLookupByLibrary.simpleMessage("Sélectionnez l'icône"),
    "savedSectionSetCoordinate" : MessageLookupByLibrary.simpleMessage("Modifier les coordonnées"),
    ...
    "tagline" : MessageLookupByLibrary.simpleMessage("Transports en commun à La Paz"),
    "teamContent" : MessageLookupByLibrary.simpleMessage("Nous sommes une équipe internationale appelée Trufi Association qui a créé cette application avec l\'aide de nombreux bénévoles! Voulez-vous améliorer l\'application trufi La Paz et faire partie de notre équipe? Merci de nous contacter via:"),
